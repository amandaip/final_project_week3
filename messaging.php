...
if ($box == "i") {
    ...
    $query = "SELECT U1.first_name, U1.last_name, U1.profile_image, MESSAGE.* FROM MESSAGE, USER as U1, USER as U2 WHERE MESSAGE.receiver_id = U1.user_id AND MESSAGE.sender_id = U2.user_id AND MESSAGE.sender_id = " . $_SESSION['user_id'];
}
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo"<img id='messaging_pic' src='img/" . $row['profile_image'] . "' alt='Profile Photo'>
